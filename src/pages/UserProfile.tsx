...
import { CalendarDays, Github, LucideMapPin, Twitter } from 'lucide-react';
...
const UserProfilePage: React.FC = () => {
  ...
  return (
    <main className="w-full h-screen bg-[#121212] text-white flex flex-col">
      <div className="flex-1 bg-[#1f1f1f] rounded-lg p-6 shadow-lg m-4" style={{ transform: "translateY(8vh)" }}>
        ...
        <div className="mt-6">
          <div className="flex items-center mb-4">
            ...
            <Link to={userData?.html_url} className="text-sm">
              {userData?.login}
            </Link>
          </div>
          {userData?.twitter_username && (
            <div className="flex items-center mb-4">
              ...
              <p className="text-sm">{userData?.twitter_username}</p>
            </div>
          )}
          <div className="flex items-center mb-4">
      ...
      <div className="flex-1 rounded-lg p-6 shadow-lg m-4 flex flex-col items-center justify-center h-full">
        <h2 className="text-2xl font-bold mb-4 text-gray-200">Theme Author Section</h2>
        <p className="text-lg text-gray-400 mb-4">Coming Soon</p>
        <p className="text-md text-gray-500 text-center">
          This section is still under construction. In the meantime, feel free to browse our available themes.
        </p>
        <Link
          to="/themes"
          className="inline-block bg-blue-500 text-white py-2 px-4 rounded-lg mt-4 hover:bg-blue-600 transition duration-300"
        >
          Browse Themes
        </Link>
      </div>
