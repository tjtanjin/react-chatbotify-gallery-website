        ...
        <div className="flex w-full h-52 justify-center items-center">
          <h1 className=" sm:text-4xl flex items-center gap-4 flex-col text-xl sm:flex-row">
            <img
              src={botAvatar}
              alt=""
              className="sm:w-20 sm:h-20 w-40 h-40 rounded-full"
            />
            React ChatBotify Theme Gallery
          </h1>
          <div className="sm:w-[40rem] sm:h-[40rem] top-0 bg-[#42b0c5] opacity-5 absolute blur-2xl rounded-full w-40 h-40" />
        </div>
        <h1 className="text-lg md:text-2xl md:font-semibold text-center py-4 text-[#42b0c5]">
          What is it?
        </h1>
        <p className="text-center py-2">
          React ChatBotify is an open-source library designed to make chatbot
          development accessible and efficient. Whether you're a seasoned
          developer or just starting out, our intuitive platform and extensive
          themes streamline the process, allowing you to focus on crafting
        ...
        <div className="pt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="flex flex-col h-[28rem] px-3">
            ...
            <div className="w-full h-1/2">
              <h1 className="text-center py-4 font-semibold text-lg text-[#42b0c5]">
                A World of Themes
              </h1>
              <p className=" text-center">
                Explore a vibrant marketplace of chatbot themes created by our
                talented developer community. Find themes for various purposes,
                from simple FAQ bots to complex conversational interfaces.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col h-[28rem] px-3">
            ...
            <div className="w-full h-1/2">
              ...
              <p className=" text-center">
                Built with open-source principles, React ChatBotify empowers you
                to customize and extend your chatbot's functionalities. Our
                themes provide a strong foundation, and the open-source nature
                allows you to tailor them to your specific needs.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col h-[28rem] px-3">
            ...
            <div className="w-full h-1/2">
              ...
              <p className=" text-center">
                ...
                Find themes perfect for straightforward interactions or dive
                into themes that enable intricate conversational flows.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col h-[28rem] px-3">
            ...
            <div className="w-full h-1/2">
              ...
              <p className=" text-center">
                Get inspired by a thriving community of developers showcasing
                their creations. Browse our community showcases to spark your
                imagination and discover the pontential of React ChatBotify
                themes.
              </p>
            </div>
          </div>
